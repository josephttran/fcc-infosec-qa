...
suite('Unit Tests', function(){
  ...
  suite('Equality', function() {
    ...
    test('#equal, #notEqual', function(){
      ...
      assert.notEqual( 6 + '2', '12', 'number + string is concatenated string' );
    });
...
// -----------------------------------------------------------------------------
  ...
  suite('Comparisons', function() {
    ...
    test('#approximately', function() {
      assert.approximately(weirdNumbers(0.5) , 1, 0.50, 0 );
      assert.approximately(weirdNumbers(0.2) , 1, 0.79, 0 );
    });
  });
